...
export const BIZ_RADAR_SEARCH_TASKS: BizRadarSearchTask[] = [
  ...
  { query: 'Bangkok Korean Supermarket', region: 'bangkok', category: 'mart' },
  { query: 'Bangkok Korean Grocery', region: 'bangkok', category: 'mart' },
  ...
  { query: 'Bangkok Korean Clinic', region: 'bangkok', category: 'hospital' },
  { query: 'Bangkok Korean Dentist', region: 'bangkok', category: 'hospital' },
  { query: 'Pattaya Korean Mart', region: 'pattaya', category: 'mart' },
  { query: 'Pattaya Korean Supermarket', region: 'pattaya', category: 'mart' },
  { query: 'Pattaya Korean Grocery', region: 'pattaya', category: 'mart' },
  ...
  { query: 'Pattaya Korean Clinic', region: 'pattaya', category: 'hospital' },
  { query: 'Pattaya Korean Dentist', region: 'pattaya', category: 'hospital' },
  { query: 'Chiang Mai Korean Mart', region: 'chiangmai', category: 'mart' },
  { query: 'Chiang Mai Korean Supermarket', region: 'chiangmai', category: 'mart' },
  { query: 'Chiang Mai Korean Grocery', region: 'chiangmai', category: 'mart' },
...
export const FORCE_BIZ_SYNC_SEARCH_TASKS: BizRadarSearchTask[] = [
  ...
  { query: 'Korean Supermarket', region: 'bangkok', category: 'mart' },
  ...
  { query: 'Korean Dentist', region: 'bangkok', category: 'hospital' },
  { query: 'Korean Pharmacy', region: 'bangkok', category: 'pharmacy' },
  { query: 'Korean Mart', region: 'pattaya', category: 'mart' },
  { query: 'Korean Supermarket', region: 'pattaya', category: 'mart' },
  ...
  { query: 'Korean Dentist', region: 'pattaya', category: 'hospital' },
  { query: 'Korean Pharmacy', region: 'pattaya', category: 'pharmacy' },
  { query: 'Korean Mart', region: 'chiangmai', category: 'mart' },
  { query: 'Korean Supermarket', region: 'chiangmai', category: 'mart' },
