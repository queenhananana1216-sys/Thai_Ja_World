...
const th: Dictionary = {
  ...
  home: {
    ...
    portalMastTitle: 'Thai Ja World — ค้นหา',
    portalMastSub:
  ...
  emergency: {
    pageTitle: 'ฉุกเฉิน·แหล่งติดต่อ (อ้างอิง) และแจ้งเบาะแส',
    pageDescription:
      'สำนักทูต·ฉุกเฉิน·สายกงสุล(อ้างอิง) การหาคนหาย/แจ้งเบาะแส ใช้บอร์ดข้อมูล+ติดต่อ — Thai Ja ไม่ใช่ ตำรวจ หรือสาย 191. เบอร์จัดการในฐานข้อมูล (แอดมิน)',
    lead: [
      'เบอร์ด้านล่างเป็น ',
      'ข้อมูลอ้างอิง',
      ' ฉุกเฉิน/อาชญากรรม/การแพทย์ โทรเจ้าหน้าที่ (191, 1669, 199 ฯลฯ) ก่อน ตรวจ ',
      'ลิงก์ทางการ',
      ' กรณี ',
      'ค้นหาหรือรายงาน',
      ' กระดาน+ติดต่อ เป็น ',
    ...
    notPolice:
      'คัดลอก Philgo ไม่ใช่ — ใช้สัมพันธ์/0404/ท้องถิ่น. อัปเดต: แอดมิน ฉุกเฉิน/ติดต่อ',
    backHome: 'กลับหน้าแรก',
    dataUnavailable: 'ยังเชื่อมฐานข้อมูล/ยัง migration ไม่เสร็จ — ใส่รายการที่แอดมิน ฉุกเฉิน/ติดต่อ',
  },
  board: {
