...
export const LANDING_PAIN_POINTS: PainPoint[] = [
  ...
  },
  {
    ...
    title: 'Unreliable Business Info',
...
export const LANDING_FEATURES: LandingFeature[] = [
  {
    id: 'info-board',
    title: 'Info Board',
    description: '검증된 생활 정보가 쌓이고 검색되는 게시판',
    bullets: ['비자·TM30·90일 리포트 실전 글', '광고성 글 분리', '지식 누적형 검색'],
    icon: '📋',
  },
  {
    id: 'ai-news',
  ...
  {
    id: 'directory',
    title: 'Korean Business Directory',
    description: '지역별 한인 업체 탐색과 미니홈 연결',
    bullets: ['방콕·파타야·치앙마이 필터', 'LINE 원클릭 연결', 'QR 기반 오프라인 유입'],
    icon: '🏪',
  },
  {
    id: 'exchange-rate',
