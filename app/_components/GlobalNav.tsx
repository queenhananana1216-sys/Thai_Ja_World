...
/**
 * app/_components/GlobalNav.tsx — 글로벌 스티키 헤더
 * 인증: 툴바 우측 Pill 전용 (본문·흰 띠에 거대 로그인 박스 없음)
 */
            ...
            {HREFS.map((href, i) => {
                ...
                href === '/'
                  ...
                  : href === '/tips'
                    ...
                    : href === '/community/boards'
                      ? pathname.startsWith('/community/boards') ||
                        pathname.startsWith('/community/trade')
                      : href === '/ilchon'
              ...
              return (
                <Link
                  ...
                  className={
                    'global-header__link' +
                    (href === '/minihome' ? ' global-header__link--minihome' : '') +
                    (isActive ? ' global-header__link--active' : '')
                  }
                >
                  {labels[i]}
                </Link>
