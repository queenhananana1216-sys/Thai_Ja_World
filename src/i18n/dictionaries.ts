...
export type Dictionary = {
  ...
  home: {
    ...
    scrollCta: string;
    /** scrollCta 옆/아래 링크 라벨(한·태 자연스럽게) */
    scrollCtaLink: string;
    /** 홈 최상단 포털형 검색 띠 제목 */
  ...
  /** /help/emergency — 긴급 연락·제보(Philgo "긴급 연락처" 대응) */
  emergency: {
    pageTitle: string;
...
const ko: Dictionary = {
  ...
  emergency: {
    pageTitle: '긴급 연락·제보 안내',
    pageDescription:
      '주태국 한국 대사관·응급·영사 연락(참고), 행방불명·제보는 광장(정보)·운영 문의로 — 태자월드는 경찰/긴급의 대체가 아닙니다. 번호는 운영자 DB에서 관리합니다.',
    lead: [
      '아래 연락처는 ',
      '참고용',
      '입니다. 비상·범죄·응급은 현지(191·1669·199 등)를 먼저, ',
      '공관·0404',
      ' 최신 안내는 링크에서 확인하세요. ',
      '제보(광장/문의)',
      '는 경찰·응급의 대체가 아닙니다. ',
    ...
    notPolice:
      '필리핀 Philgo의 동일 UI 복제가 아니라, 태국·한국 공개 안내를 토대로 한 2026형 허브입니다. 번호 변경 시 관리자의 긴급 연락 메뉴에서 갱신합니다.',
    backHome: '홈으로',
    dataUnavailable: 'DB 연결·마이그레이션이 아직이면 여기는 비어 보일 수 있어요. 관리자 → 긴급 연락에서 항목을 넣으세요.',
  },
  board: {
    pageTitle: '광장 게시판',
    newPost: '글 올리기',
...
const th: Dictionary = {
  ...
  lang: { ko: '한국어', th: 'ไทย' },
  footer:
    '© 2026 Thai Ja World · thaijaworld.com | กระดานชีวิตในไทย — รีวิว ข่าว มือสอง ร้าน งาน มินิโฮม (ทีมงานเว็บดูแล ไม่ใช่ AI มาตอบ)',
  footerNav: {
  ...
  home: {
    tag: 'THAI JA WORLD · ชีวิตที่ไทย มาคุยก่อน',
    title: 'อยู่ไทยแล้วติดตรงไหน มาเล่า มาหาข้อมูลที่นี่',
    heroKicker: 'รีวิว · ข่าว · ร้าน · ลานคุย',
    heroLead: 'ตรงนี้ไม่ใช่แบนเนอร์ล้นๆ แต่เว็บที่คนมาช่วยกันจริง',
    heroSub:
      'เช่า วีซ่า รพ. ฯลฯ มีอะไรรึเปล่า แบ่งกัน แล้วรุ่นถัดไปได้อ่าน\nข้อมูลจริง รีวิวจริง คำเตือนจริง มากกว่าแค่ลงโฆษณา — เขียนสั้นๆ ก็ได้ แวะมาวันไหนก็ยินดี',
    scrollCta:
      'โฆษณาเยอะอย่างเดียวไม่ใช่ — งานสะดุด มาเล่า มาถาม มาแบ่งกันที่นี่. มือใหม่ทักทายกระทู้แรกที่ลาน รับแต้มสไตล์ครั้งเดียว (เงื่อนไขตามกติกาเว็บ)',
    scrollCtaLink: 'ไปลาน',
    portalMastTitle: 'Thai Ja World — ค้นหาในเว็บ',
    portalMastSub:
      'บ้าน วีซ่า ร้าน ลานคุย ข่าว มินิโฮม — ก่อนหาไกล ลองค้นจากสมาชิกก่อน ชุมชนคนไทย–เกาหลีที่นี่ จัดทีมงานดูแล ไม่ใช่บอทมาตอบ',
  ...
  tips: {
    pageTitle: 'รวมเทคนิคใช้ชีวิต (ไทย) — จากกระดาน',
    pageLead:
      'อ่านรายการสั้นๆ ที่นี่ก่อน บางหัวข้อจะเปิดฉบับเต็มบนบอร์ด — ล็อกอินแล้วกดไปที่ลาน ตั้งกระทู้/ถามต่อ ได้',
    openCard: 'อ่านต่อ',
    detailLockedLead:
      'เช็กลิสต์+ลิงก์+ข้อสังเกตฉบับเต็ม — ล็อกอินแล้วอ่านโพสต์ฉบับเดิมบนบอร์ด “ข้อมูล” รวมอ่านจบในหน้าเดิม',
    ...
    crossLinkNewsHub: 'สรุปข่าว+หัวฮอต ไปที่ /news ได้',
  },
  emergency: {
    pageTitle: 'ฉุกเฉิน & ลิงก์ทางการ (อ่านอ้างอิง) · แจ้งข่าว/หาย ผ่านกระดาน',
    pageDescription:
      'เบอร์สถานฯ/ฉุกเฉิน/0404(ฝ่ายแอดมินอัปเดต) — Thai Ja เป็นกระดาน+ทีม ไม่แทน 191/ตำรวจ/หน่วยงานราชการ อ่านเว็บทูต+0404 ฉบับเต็ม',
    lead: [
      'รายการด้านล่าง',
      'ใช้ประกอบเท่านั้น',
      ' ถ้าเป็นเรื่อง',
      'ฉุกเฉิน/อันตราย/แพทย์',
      ' โทร 191, 1669, 199 ฯลฯ ก่อน ยืนยันจาก',
      'เว็บทูต/เว็บ 0404',
      ' ทุกครั้ง กรณี',
      'หาเบาะแส/รายงาน/หาเพื่อน/ของหาย',
      ' มา',
      'โพสต์บอร์ดข้อมูล+ทักทีม (หน้า "ติดต่อ") ได้ แต่',
      'ไม่ใช่ตัวแทนเจ้าหน้าที่',
      ' โปรด',
      'ไม่แชร์รูป/รายละเอียดคนเจอบนกระดานสาธารณะ',
      ' ทีมอาจลบ/ปิดส่วนที่เสี่ยง',
    ],
    notPolice:
      'Thai Ja ไม่ได้ออกแบบให้ก็อปเว็บ Philgo; อัปเดตเบอร์จากฝั่ง “แอดมิน → ฉุกเฉิน / ติดต่อ”',
    backHome: 'กลับหน้าแรก',
    dataUnavailable: 'ฝั่งเว็บยังโหลดรายการเบอร์ไม่เจอ — แอดมินอัปโหลด/มิกเรชันเสร็จ แล้วลองใหม่',
  },
  board: {
  ...
  search: {
    ...
    heroTitle: 'กำลังมองหาข้อมูลอะไรอยู่',
    portalLead: 'เช่น มือสอง ร้านอาหาร วีซ่า บอร์ด ลงทะเบียน ฯลฯ (พิมพ์เบาๆ ก็เจอ)',
    placeholder: 'เช่น วีซ่า, ร้านเกาหลี, ลานคุย…',
    hint: '',
    noResults: 'ยังไม่เจอ ลองคำอื่น หรือเลือกจากรายการด้านล่าง',
    quickHeading: 'ทางลัดยอดนิยม',
    sectionPages: 'เมนู & กระดาน',
    sectionNews: 'สรุปข่าวอ้างอิง',
    badgeMember: 'ล็อกอิน—อ่านเต็ม·ตอบกระทู้ได้',
    badgePublic: 'กดไปดู',
    searching: 'กำลังค้นหา…',
  },
  ...
  seo: {
    ...
    defaultDescription:
      'Thai Ja World — กระดานสำหรับคนใช้ชีวิตในไทย รีวิว ร้าน งาน มือสอง มินิโฮม ไม่ใช่บอตมาสรุป',
    homeTitle: 'หน้าแรก — Thai Ja World',
    homeDescription:
      'Thai Ja World ลานสนทนา+ข้อมูล สมาชิกช่วยกันแชร์ ทีมงานดูเว็บ ไม่ใช่รูป AI กดปุ่ม',
    boardsListDescription:
